...
public class Helicoptero extends VeiculoAereo 
{
	 ...
	 * @param modelo
	 */
	public Helicoptero(String cor, String materialPrincipal, String meioLocomocao, int qtPassageiros, boolean possuiAsa, String tipoPropulsao, int ano, String modelo) 
	{
